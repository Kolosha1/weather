...
class WeatherCard(MDCard):
    def __init__(self, date,image,temp,temp_like,desc,wind_speed,humidity,*args, **kwargs):
        ...
        self.ids.temp_like.text = f'{temp_like} °C'
        self.ids.desc = desc
        self.ids.wind_speed.text = f'Швидкість вітру: {wind_speed} м/с'
        self.ids.wind_speed.text = f'Вологість: {humidity} %'
...
class HomeScreen(MDScreen):
    ...
    def get_weather_data(self,url,city):
        """Функція робить запить до сайту погоди і повертає JSON файл з результатом"""
